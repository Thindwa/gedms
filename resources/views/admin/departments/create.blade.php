...
@section('content')
<div class="max-w-2xl">
    <h1 class="text-xl font-semibold text-slate-800 mb-4">Add Department</h1>
            ...
            <div class="space-y-4">
                <div>
                    ...
                    <input type="text" id="name" name="name" value="{{ old('name') }}" required
                           class="input-field" placeholder="e.g. Human Resources">
                    @error('name')
                ...
                <div>
                    <label for="ministry_id" class="block text-sm font-medium text-slate-700 mb-1">Ministry</label>
                    <select id="ministry_id" name="ministry_id" required class="input-field">
                ...
                <div>
                    ...
                    <input type="text" id="code" name="code" value="{{ old('code') }}"
                           class="input-field" placeholder="e.g. HR">
                    @error('code')
                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                    @enderror
                </div>
