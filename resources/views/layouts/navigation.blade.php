<nav x-data="{ open: false }" class="bg-white border-b border-gray-100">
        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    @if (Auth::user()?->can('approve-documents'))
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            @endif
            @if (Auth::user()?->can('manage-document-types') || Auth::user()?->can('manage-sensitivity-levels') || Auth::user()?->can('manage-workflows') || Auth::user()?->can('manage-retention') || Auth::user()?->can('manage-roles') || Auth::user()?->can('view-audit-logs'))
